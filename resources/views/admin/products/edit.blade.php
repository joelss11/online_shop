                    ...
                    <div class="row" id="product-gallery">
                        ...
                        <div class="col-md-3" id="image-row-{{ $image->id }}">
                            <div class="card">
                                ...
                                <img style="height:90px;" src="{{asset('uploads/product/small/'.$image->image)}}" class="card-img-top" alt="" />
                                <div class="card-body">
...
<script>
    ...
    $("#productForm").submit(function(event) {
        ...
        $.ajax({
            ...
            error: function() {
                console.log("Something Went Strong");
            }
        });
    });
  ...
  <img style="height:90px;" src="${response.ImagePath}" class="card-img-top" alt=""/>
  <div class="card-body">
